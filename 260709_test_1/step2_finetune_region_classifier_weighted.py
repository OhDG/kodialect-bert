...
DEFAULT_OUTPUT_DIR = "./small_bert_region_classifier_weighted"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Use weighted cross entropy to reduce region imbalance. sqrt_balanced is milder than balanced.",
    )
