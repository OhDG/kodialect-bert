...
def evaluate_model():
    # 최신 학습 코드 기준 경로
    model_path = "./my_dialect_bert_final_fast"
    ...
    # tokenizer도 최종 저장된 모델 폴더에서 같이 불러오기
    ...
    print("\n" + "=" * 60)
    print(f"✅ 홀드아웃 기준 최종 전체 Accuracy: {acc * 100:.2f}%")
    print(f"✅ 홀드아웃 기준 최종 Macro F1 : {macro_f1 * 100:.2f}%")
    print("=" * 60)
