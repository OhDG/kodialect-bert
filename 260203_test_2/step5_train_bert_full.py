...
# 연구실 컴용
    ...
    #     per_device_train_batch_size=16,  # VRAM 12GB에서는 16~24가 안정적입니다.
    #     gradient_accumulation_steps=4,   # 실질적 배치 사이즈를 64(16x4)로 맞춰 학습 안정성 확보
    #     fp16=True,                       # 40시리즈의 텐서 코어를 활용해 속도와 메모리 효율 극대화
    #     # --------------------------------------
    ...
    #     logging_dir="./logs",
    #     logging_steps=100,
    #     dataloader_num_workers=4,        # 윈도우 환경에서는 너무 높으면 에러가 날 수 있어 4 권장
